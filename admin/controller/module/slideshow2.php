...
class ControllerModuleSlideshow2 extends Controller {
	...
	public function index() {   
		...
		$this->data['action'] = $this->url->link('module/slideshow2', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['slideshow2_module'])) {
			...
			$this->data['modules'] = $this->config->get('slideshow2_module');
		}	
		...
		$this->template = 'module/slideshow2.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	protected function validate() {
		...
		if (isset($this->request->post['slideshow2_module'])) {
			foreach ($this->request->post['slideshow2_module'] as $key => $value) {
