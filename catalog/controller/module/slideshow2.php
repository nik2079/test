...
class ControllerModuleSlideshow2 extends Controller {
	protected function index($setting) {
		if((int)$setting['store_id'] == (int)$this->config->get('config_store_id')){
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/slideshow.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/module/slideshow2.tpl';
			} else {
				$this->template = 'default/template/module/slideshow2.tpl';
			}
